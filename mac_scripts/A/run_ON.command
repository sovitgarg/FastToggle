#!/bin/bash
# Toggle all URLs in ToggleExcel.xlsx to ON
...
python3 ../../_system/scripts/toggle_automation.py "ToggleExcel.xlsx" --state ON --no-headless

mkdir -p output
mv toggle_results.xlsx output/toggle_results_ON.xlsx 2>/dev/null
