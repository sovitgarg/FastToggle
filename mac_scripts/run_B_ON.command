#!/bin/bash
# Set all toggles in ToggleExcel_B.xlsx to ON
...
python3 _system/scripts/toggle_automation.py "ToggleExcel_B.xlsx" --state ON --no-headless

# Move results to output folder
mv toggle_results.xlsx output/toggle_results_B_ON.xlsx 2>/dev/null
