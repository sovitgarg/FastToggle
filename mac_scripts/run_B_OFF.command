#!/bin/bash
# Set all toggles in ToggleExcel_B.xlsx to OFF

# Navigate to parent folder (FastToggle)
cd "$(dirname "$0")/.."

echo "========================================="
echo "  Toggle Automation - Set B to OFF"
echo "========================================="
echo ""
...
python3 _system/scripts/toggle_automation.py "ToggleExcel_B.xlsx" --state OFF --no-headless

# Move results to output folder
mv toggle_results.xlsx output/toggle_results_B_OFF.xlsx 2>/dev/null
