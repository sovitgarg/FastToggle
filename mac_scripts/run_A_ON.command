#!/bin/bash
# Set all toggles in ToggleExcel_A.xlsx to ON
...
python3 _system/scripts/toggle_automation.py "ToggleExcel_A.xlsx" --state ON --no-headless

# Move results to output folder
mv toggle_results.xlsx output/toggle_results_A_ON.xlsx 2>/dev/null
