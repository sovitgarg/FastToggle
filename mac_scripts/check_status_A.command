#!/bin/bash
# Check toggle status for all URLs in ToggleExcel_A.xlsx
...
python3 _system/scripts/check_status.py "ToggleExcel_A.xlsx" --no-headless

# Move results to output folder
mv status_report.xlsx output/status_report_A.xlsx 2>/dev/null
